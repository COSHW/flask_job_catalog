...
def nextPage():
    ...
    if flask.request.values.to_dict()['FindBy'] != '':
        ...
        return flask.render_template("index3.html", name=flask.request.values.to_dict()['REGName'], surname=flask.request.values.to_dict()['REGLastName'], FIO=flask.request.values.to_dict()['REGLastName']+" "+flask.request.values.to_dict()['REGName'][0]+". "+flask.request.values.to_dict()['REGPatro'][0]+".", code=flask.request.values.to_dict()['REGPhone'][7:11])
    else:
